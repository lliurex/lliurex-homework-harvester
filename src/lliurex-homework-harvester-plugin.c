...
thunar_extension_initialize (ThunarxProviderPlugin *plugin)
{
  ...
  /* setup i18n support */
  bindtextdomain ("lliurex-homework-harvester", PACKAGE_LOCALE_DIR);
#ifdef HAVE_BIND_TEXTDOMAIN_CODESET
  bind_textdomain_codeset ("lliurex-homework-harvester", "UTF-8");
#endif
  ...
  lhh_provider_register_type (plugin);

  /* setup the plugin provider type list */
  type_list[0] = LHH_TYPE_PROVIDER;
}
